...
- Receipts must state each mechanism, assurance level, scope, and limitation. Canonical pathname revalidation is not native-object identity, observation is not enforcement, and best-effort cleanup is not ManagedTree ownership.
