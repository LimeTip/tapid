...
- Stable release installation and `tapid upgrade` now verify signed release manifests and artifacts, but production readiness still requires a real cross-platform published release, protected CI secret configuration, endpoint publication, and completed recovery testing.
