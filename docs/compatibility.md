...
| npm registry | Reads npm `versions`, validates package/version identity and HTTPS tarballs, and requires a valid SHA-512 `dist.integrity` | Aliases, tags, git, file, workspace specs, private authentication, and complete packument behavior are unsupported |
