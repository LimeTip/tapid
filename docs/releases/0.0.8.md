...
- Verifies public installation and binary execution on Ubuntu, macOS, and Windows after publication.

## Installer safety

- Enforces bounded HTTPS downloads and conservative archive and executable size limits.
